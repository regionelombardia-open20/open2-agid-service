...
/**
 * This is the base-model class for table "agid_service_type".
 *
 * @property integer $id
 ...
 */
abstract class AgidServiceType extends \open20\amos\core\record\Record
{
    ...
    {
        return $this->hasMany(\open20\agid\service\models\AgidService::className(), ['agid_service_type_id' => 'id']);
    }
}
